...
public class Claim
{
    ...
    public Claim(UUID id, String externalReference, String clientId, String policyNumber, ClaimType claimType,
            ClaimStatus status, ClaimPriority priority, LocalDate incidentDate, BigDecimal amount, String currency,
            Instant createdAt)
    {
        this.id = id;
    ...
    public static Claim receive(UUID id, String externalReference, String clientId, String policyNumber,
            ClaimType claimType, LocalDate incidentDate, BigDecimal amount, String currency, Instant receivedAt)
    {
        ...
        return new Claim(id, externalReference, clientId, policyNumber, claimType, ClaimStatus.RECEIVED, priority,
                incidentDate, amount, currency, receivedAt);
    }
    ...
    private void validateTransition(ClaimStatus nextStatus)
    {
        ...
        if (status == ClaimStatus.VALIDATING && (nextStatus == ClaimStatus.MANUAL_REVIEW
        ...
        throw new IllegalStateException("Invalid claim transition from " + status + " to " + nextStatus);
    }
