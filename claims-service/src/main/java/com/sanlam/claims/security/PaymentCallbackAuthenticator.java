...
public class PaymentCallbackAuthenticator
{
    ...
    public PaymentCallbackAuthenticator(@Value("${security.payment-callback.secret}") String secret,
            @Value("${security.payment-callback.max-age:5m}") Duration maxAge, Clock clock)
    {
