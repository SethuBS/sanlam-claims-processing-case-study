...
import com.sanlam.claims.security.PaymentCallbackAuthenticationException;
...
public class ApiExceptionHandler
{
    ...
    ProblemDetail handlePaymentCallbackAuthentication(PaymentCallbackAuthenticationException exception)
    {
